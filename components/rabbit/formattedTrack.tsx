  ...
  return (
    <div className='flex gap-4 w-full items-center cursor-pointer truncate select-none' onClick={() => {
      ...
      <button onClick={e => {
        ...
        {track.saved ?
          <svg className='text-green-500 hover:text-green-300' width='24' height='24' viewBox='0 0 150 150' fill='none' xmlns='http://www.w3.org/2000/svg'>
          ...
          :
          <svg className='text-neutral-500 hover:text-neutral-300' width='24' height='24' viewBox='0 0 150 150' fill='none' strokeWidth='6' stroke='currentColor' xmlns='http://www.w3.org/2000/svg'>
