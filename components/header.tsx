    ...
    <header className='fixed flex justify-center w-full z-20'>
      ...
      <nav className='w-full max-w-7xl'>
        <div className='flex justify-between'>
          <div className='flex items-center gap-4 h-14 px-4 font-medium'>
          ...
          <div className='flex items-center gap-6 h-14 px-4 font-medium'>
            ...
            <button aria-label='Light Mode' className='hover:text-neutral-400 transition' onClick={() => setTheme(resolvedTheme === 'dark' ? 'light' : 'dark')}>
