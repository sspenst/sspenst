    ...
    <div className='flex justify-center'>
      <div className='flex flex-col w-full gap-6 text-sm px-8 pt-6 pb-12 max-w-2xl'>
        <RevealText className='flex flex-col gap-6'>
          ...
          <p>
            I graduated from <FaviconLink href='https://ubc.ca'>UBC</FaviconLink> in Computer Engineering. While I was there I had the chance to work as a research assistant focusing on GPU optimizations for machine learning.
          </p>
          <p>
            I like to build solutions to problems I see in my own life. I made <FaviconLink href='https://chromewebstore.google.com/detail/simplify-youtube/lcakcdjbimeedkincdcpphddbjdmdhaa'>Simplify YouTube</FaviconLink> to remove Shorts and other distracting UX elements, and I was a top contributor to the <FaviconLink href='https://www.npmjs.com/package/@sspenst/spotify-web-api'>Spotify Web API</FaviconLink> so I could build <FaviconLink href='https://rabbit.sspenst.com'>Rabbit</FaviconLink>, a quick way to discover new music.
          </p>
          <p>
